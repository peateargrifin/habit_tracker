...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.done.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.done);
...
habit _habitDeserialize(
  ...
  final object = habit();
  object.done = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension habitQueryFilter on QueryBuilder<habit, habit, QFilterCondition> {
  QueryBuilder<habit, habit, QAfterFilterCondition> doneElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'done',
        0,
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'done',
        0,
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<habit, habit, QAfterFilterCondition> doneLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension habitQueryProperty on QueryBuilder<habit, habit, QQueryProperty> {
  ...
  QueryBuilder<habit, List<DateTime>, QQueryOperations> doneProperty() {
    return QueryBuilder.apply(this, (query) {
